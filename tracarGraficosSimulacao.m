function tracarGraficosSimulacao(simulacao, planta)
...
figure;
hold on;
plot(simulacao.h1.time, simulacao.h1.signals.values, 'r', 'LineWidth', 2);
plot(simulacao.h2.time, simulacao.h2.signals.values, 'b', 'LineWidth', 2);
xlabel('Tempo (s)', 'FontSize', 14);
ylabel('Altura (m)', 'FontSize', 14);
set(gca, 'FontSize', 14);
legend('Executado h_1', 'Executado h_2');
grid on;
%axis equal;
%salvarGrafico(sprintf('h1h2_%c', simulacao.experimento), formato);
